        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ route('acara.save') }}" method="POST">
                {{ csrf_field() }}
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="bmd-label-floating">Judul Acara</label>
                        <input type="text" class="form-control" name="judulacara">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="bmd-label-floating"> Deskripsi Acara</label>
                        <textarea class="form-control" rows="3" name="deskripsiacara"></textarea>
                      </div>
                    </div>
                  </div>
